...
const createFormerSchoolValidators = () => ({
  ...
  validateName: validateInput('name', { maxLength: 255, required: true }),
...
// Factory function to generate validators for updating FormerSchool model
const createUpdateFormerSchoolValidators = () => ({
  // Validator for name (optional, max length 255 characters)
...
// Generate validators using the factory function
const updateFormerSchoolValidators = createUpdateFormerSchoolValidators();

// Group validators into an array for middleware usage
export const updateFormerSchoolValidationMiddleware = Object.values(
  updateFormerSchoolValidators
);
